...
void Board::SetupBoard()
{
	...
	m_BoardSquares[0 * Width + 8] = Square{ true,
		std::make_unique<King>(m_Engine.GetTextureManager().GetKingTexture(EPieceColor::Black), EPieceColor::Black, 8, BlackPieceRow) };
	m_BoardSquares[(Height - 1) * Width + 8] = Square{ true,
		std::make_unique<King>(m_Engine.GetTextureManager().GetKingTexture(EPieceColor::White), EPieceColor::White, 8, WhitePieceRow) };

	// Queens
	m_BoardSquares[BlackPieceRow * Width + 7] = Square{ true,
		std::make_unique<Queen>(m_Engine.GetTextureManager().GetQueenTexture(EPieceColor::Black), EPieceColor::Black, 7, BlackPieceRow) };
	m_BoardSquares[WhitePieceRow * Width + 7] = Square{ true,
		std::make_unique<Queen>(m_Engine.GetTextureManager().GetQueenTexture(EPieceColor::White), EPieceColor::White, 7, WhitePieceRow) };

	// Rooks
	// Black Rooks
	m_BoardSquares[BlackPieceRow * Width + 0] = Square{ true,
		std::make_unique<Rook>(m_Engine.GetTextureManager().GetRookTexture(EPieceColor::Black), EPieceColor::Black, 0, BlackPieceRow) };
	m_BoardSquares[BlackPieceRow * Width + 15] = Square{ true,
		std::make_unique<Rook>(m_Engine.GetTextureManager().GetRookTexture(EPieceColor::Black), EPieceColor::Black, 15, BlackPieceRow) };
	// White Rooks
	m_BoardSquares[WhitePieceRow * Width + 0] = Square{ true,
		std::make_unique<Rook>(m_Engine.GetTextureManager().GetRookTexture(EPieceColor::White), EPieceColor::White, 0, WhitePieceRow) };
	m_BoardSquares[WhitePieceRow * Width + 15] = Square{ true,
		std::make_unique<Rook>(m_Engine.GetTextureManager().GetRookTexture(EPieceColor::White), EPieceColor::White, 15, WhitePieceRow) };

	// Knights
	// Black Knights
	m_BoardSquares[BlackPieceRow * Width + 1] = Square{ true,
		std::make_unique<Knight>(m_Engine.GetTextureManager().GetKnightTexture(EPieceColor::Black), EPieceColor::Black, 1, BlackPieceRow) };
	m_BoardSquares[BlackPieceRow * Width + 14] = Square{ true,
		std::make_unique<Knight>(m_Engine.GetTextureManager().GetKnightTexture(EPieceColor::Black), EPieceColor::Black, 14, BlackPieceRow) };
	// White Knight
	m_BoardSquares[WhitePieceRow * Width + 1] = Square{ true,
		std::make_unique<Knight>(m_Engine.GetTextureManager().GetKnightTexture(EPieceColor::White), EPieceColor::White, 1, WhitePieceRow) };
	m_BoardSquares[WhitePieceRow * Width + 14] = Square{ true,
		std::make_unique<Knight>(m_Engine.GetTextureManager().GetKnightTexture(EPieceColor::White), EPieceColor::White, 14, WhitePieceRow) };

	// Wizards
	// Black Wizards
	m_BoardSquares[BlackPieceRow * Width + 2] = Square{ true,
		std::make_unique<Wizard>(m_Engine.GetTextureManager().GetWizardTexture(EPieceColor::Black), EPieceColor::Black, 2, BlackPieceRow) };
	m_BoardSquares[BlackPieceRow * Width + 13] = Square{ true,
		std::make_unique<Wizard>(m_Engine.GetTextureManager().GetWizardTexture(EPieceColor::Black), EPieceColor::Black, 13, BlackPieceRow) };
	// White Wizards
	m_BoardSquares[WhitePieceRow * Width + 2] = Square{ true,
		std::make_unique<Wizard>(m_Engine.GetTextureManager().GetWizardTexture(EPieceColor::White), EPieceColor::White, 2, WhitePieceRow) };
	m_BoardSquares[WhitePieceRow * Width + 13] = Square{ true,
		std::make_unique<Wizard>(m_Engine.GetTextureManager().GetWizardTexture(EPieceColor::White), EPieceColor::White, 13, WhitePieceRow) };

	// Champions
	// Black Champions
	m_BoardSquares[BlackPieceRow * Width + 3] = Square{ true,
		std::make_unique<Champion>(m_Engine.GetTextureManager().GetChampionTexture(EPieceColor::Black), EPieceColor::Black, 3, BlackPieceRow) };
	m_BoardSquares[BlackPieceRow * Width + 12] = Square{ true,
		std::make_unique<Champion>(m_Engine.GetTextureManager().GetChampionTexture(EPieceColor::Black), EPieceColor::Black, 12, BlackPieceRow) };
	// White Wizards
	m_BoardSquares[WhitePieceRow * Width + 3] = Square{ true,
		std::make_unique<Champion>(m_Engine.GetTextureManager().GetChampionTexture(EPieceColor::White), EPieceColor::White, 3, WhitePieceRow) };
	m_BoardSquares[WhitePieceRow * Width + 12] = Square{ true,
		std::make_unique<Champion>(m_Engine.GetTextureManager().GetChampionTexture(EPieceColor::White), EPieceColor::White, 12, WhitePieceRow) };

	// Bishops
	// Black Bishops
	m_BoardSquares[BlackPieceRow * Width + 4] = Square{ true,
		std::make_unique<Bishop>(m_Engine.GetTextureManager().GetBishopTexture(EPieceColor::Black), EPieceColor::Black, 4, BlackPieceRow) };
	m_BoardSquares[BlackPieceRow * Width + 11] = Square{ true,
		std::make_unique<Bishop>(m_Engine.GetTextureManager().GetBishopTexture(EPieceColor::Black), EPieceColor::Black, 11, BlackPieceRow) };
	// White Bishops
	m_BoardSquares[WhitePieceRow * Width + 4] = Square{ true,
		std::make_unique<Bishop>(m_Engine.GetTextureManager().GetBishopTexture(EPieceColor::White), EPieceColor::White, 4, WhitePieceRow) };
	m_BoardSquares[WhitePieceRow * Width + 11] = Square{ true,
		std::make_unique<Bishop>(m_Engine.GetTextureManager().GetBishopTexture(EPieceColor::White), EPieceColor::White, 11, WhitePieceRow) };

	// Roses
	// Black Rose
	m_BoardSquares[BlackPieceRow * Width + 5] = Square{ true,
		std::make_unique<Rose>(m_Engine.GetTextureManager().GetRoseTexture(EPieceColor::Black), EPieceColor::Black, 5, BlackPieceRow) };
	// White Rose
	m_BoardSquares[WhitePieceRow * Width + 5] = Square{ true,
		std::make_unique<Rose>(m_Engine.GetTextureManager().GetRoseTexture(EPieceColor::White), EPieceColor::White, 5, WhitePieceRow) };

	// Archbishops
	// Black Archbishop
	m_BoardSquares[BlackPieceRow * Width + 6] = Square{ true,
		std::make_unique<Archbishop>(m_Engine.GetTextureManager().GetArchbishopTexture(EPieceColor::Black), EPieceColor::Black, 6, BlackPieceRow) };
	// White Archbishop
	m_BoardSquares[WhitePieceRow * Width + 6] = Square{ true,
		std::make_unique<Archbishop>(m_Engine.GetTextureManager().GetArchbishopTexture(EPieceColor::White), EPieceColor::White, 6, WhitePieceRow) };

	// Chancellors
	// Black Chancellor
	m_BoardSquares[BlackPieceRow * Width + 9] = Square{ true,
		std::make_unique<Chancellor>(m_Engine.GetTextureManager().GetChancellorTexture(EPieceColor::Black), EPieceColor::Black, 9, BlackPieceRow) };
	// White Chancellor
	m_BoardSquares[WhitePieceRow * Width + 9] = Square{ true,
		std::make_unique<Chancellor>(m_Engine.GetTextureManager().GetChancellorTexture(EPieceColor::White), EPieceColor::White, 9, WhitePieceRow) };

	// Fools
	// Black Fool
	m_BoardSquares[BlackPieceRow * Width + 10] = Square{ true,
		std::make_unique<Fool>(m_Engine.GetTextureManager().GetFoolTexture(EPieceColor::Black), EPieceColor::Black, 10, BlackPieceRow) };
	// White Fool
	m_BoardSquares[WhitePieceRow * Width + 10] = Square{ true,
		std::make_unique<Fool>(m_Engine.GetTextureManager().GetFoolTexture(EPieceColor::White), EPieceColor::White, 10, WhitePieceRow) };
}
